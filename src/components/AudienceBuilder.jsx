...
const AudienceBuilder = () => {
    ...
    useEffect(() => {
        const checkLoginStatus = async () => {
            try {
                ...
                const response = await axios.get('http://localhost:3000/api/is-logged-in', { withCredentials: true });
    ...
    const handleTextToRules = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post('http://localhost:3000/api/ai/text-to-rules', { prompt: prompt });
    ...
    const handleCreateCampaign = async () => {
        ...
        try {
            setLoading(true);
            const response = await axios.post(
                'http://localhost:3000/api/campaigns/create',
